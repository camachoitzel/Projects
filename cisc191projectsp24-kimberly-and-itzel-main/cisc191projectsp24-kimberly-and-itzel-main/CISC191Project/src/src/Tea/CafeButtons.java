...
//    	backFrame.add(myLabel);
        ...
        btn1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				 ImageIcon backgroundImage = createImageIcon("Resources2/menu.jpg"); //needs a new method, its at the bottom
			        if (backgroundImage != null) {
			            JLabel backgroundLabel = new JLabel(backgroundImage);
			            backgroundLabel.setBounds(0, 0, 1800, 1000);
			            panel.add(backgroundLabel);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        }else if (clickedButton.getText().equals("MENU")) {    
            ImageIcon menuImage = createImageIcon("Resources2/menu.jpg");
        	if (menuImage != null) {
        		JOptionPane.showMessageDialog(frame, new JLabel(menuImage), "Menu", JOptionPane.PLAIN_MESSAGE);
        	}
        	
        }else if (clickedButton.getText().equals("ABOUT US")) {
        	JOptionPane.showMessageDialog(frame,"Our Journey to Boba Oasis Cafe\n\n" +
        "Itzel and Kimberly have dreamt of opening a cafe since they were kids. \n" +
        "After years of planning and hard work, we finally made it happen \n" +
        "with Boba Oasis Cafe. We are very grateful for the support of our amazing customers. " +
        " "+
        
        "Thank you for helping us turn our dream into a reality",
